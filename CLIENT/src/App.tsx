...
import GlobalLoginModal from './pages/componentes/GlobalLoginModal';
...
// import InfoPagamento from './pages/reservarEntrada/infoPagamento_tua_version.tsx';
import InfoPagamento from './pages/reservarEntrada/infoPagamento.tsx';
...
import GestionEntradas from './pages/crearEvento/7GestionEntradas';
        ...
        <>
          <Routes>
            ...
            <Route path="crear-evento" element={<CreateEventLayout />}>
              ...
              <Route path="gestion-entradas" element={<GestionEntradas />} />
            ...
            <Route path="escanear-entradas" element={<EscanearEntrada />} />
          </Routes>
